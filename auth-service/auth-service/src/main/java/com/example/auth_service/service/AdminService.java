...
public class AdminService {
    ...
    public AdminService(CustomerRepository customerRepository, BCryptPasswordEncoder passwordEncoder) {
    ...
    public RegisterResponse createAdmin(AdminRegisterRequest request) {
        ...
        return new RegisterResponse("Admin created successfully", admin.getRole());
    }
